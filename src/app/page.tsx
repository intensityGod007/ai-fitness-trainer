    ...
    <div className='flex flex-col min-h-screen text-foreground overflow-hidden'>
      <section className='relative z-10 py-24 grow'>
        <div className='container mx-auto px-20'>
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-center justify-center relative'>
            {/* CORNER DECORATION */}
              ...
              <div className='relative aspect-square max-w-lg mx-auto'>
                <div className='relative overflow-hidden rounded-lg bg-black'>
                  ...
                  <div className='absolute inset-0 pointer-events-none'>
                    ...
                    <div className='absolute left-1/2 top-0 h-1/4 w-px bg-primary/50'></div>
                    <div className='absolute left-1/2 bottom-0 h-1/4 w-px bg-primary/50'></div>
                  </div>
